...
compile commmand:
gcc -fPIC -shared -o plugins/fun_facts/fun_facts.so \
  plugins/fun_facts/fun_facts.c \
...
static void rebuild_texts(State *s) {
    ...
    snprintf(line1, sizeof(line1), "Fun Facts :)");
    snprintf(line2, sizeof(line2), "");
    snprintf(line3, sizeof(line3), "Computer Science has a 6.1 unemployment rate.");
    snprintf(line4, sizeof(line4), "Mathematics has a 3.7 unemployment rate.");
